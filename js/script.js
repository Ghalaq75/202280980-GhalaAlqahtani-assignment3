...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Scroll animations (re-run after repos load since cards are dynamic)
    observeElements();
    ...
    // Live word count + char count on message textarea
    initMessageCounters();

    // Real-time field validation on blur and correction on input
...
console.log('%cGhala\'s Portfolio – Assignment 3', 'color:#5a5a5a; font-size:14px;');
console.log('%cFeatures: Live Word Count · Filter & Sort · GitHub API · Quotes API · Dark Mode · Form Validation', 'color:#8a8a8a; font-size:12px;');